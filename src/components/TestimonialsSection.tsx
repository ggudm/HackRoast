...
const testimonials = [
  ...
  },
  {
    id: 2,
    image: photo2,
    quote: 'До HackRoast я даже не знала, с чего начать. Программа помогла мне разобраться в основах, найти команду и выиграть первый хакатон за месяц. Теперь у меня есть портфолио и уверенность в своих силах.',
    name: 'Анна',
    age: '21 год',
  ...
  },
  {
    id: 3,
    image: photo3,
    quote: 'Самое ценное в HackRoast — это не только обучение, но и сообщество. Здесь я нашёл единомышленников, с которыми мы продолжаем работать над проектами и после хакатонов.',
    name: 'Дмитрий',
    age: '23 года',
